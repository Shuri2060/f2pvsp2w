((function(window) {
    ...
    Module["postRun"].push((function() {
        window["input"] = {
            ...
            "blur": _7cf8f909,
            "wheel": _2caae9bd,
            "prevent_right_click": _72a4bb00,
            "flushInputHooks": _49f8eea6,
            ...
            "print_convar_help": _1f370367,
            "should_prevent_unload": _14f2e186
        }
    }));
    ...
    function allocate(slab, types, allocator, ptr) {
        ...
        if (allocator == ALLOC_NONE) {
            ...
            ret = [typeof _1f495e7f === "function" ? _1f495e7f : Runtime.staticAlloc, Runtime.stackAlloc, Runtime.staticAlloc, Runtime.dynamicAlloc][allocator === undefined ? ALLOC_STATIC : allocator](Math.max(size, singleType ? 1 : types.length))
        }
        if (zeroinit) {
            var ptr = ret,
                stop;
    ...
    function demangle(func) {
        var _1af2caa5 = Module["_7065227f"] || Module["_70cfc032"];
        if (_1af2caa5) {
            try {
                var s = func.substr(1);
                var len = lengthBytesUTF8(s) + 1;
                var buf = _1f495e7f(len);
                stringToUTF8(s, buf, len);
                var status = _1f495e7f(4);
                var ret = _1af2caa5(buf, 0, 0, status);
                if (getValue(status, "i32") === 0 && ret) {
                    return Pointer_stringify(ret)
                }
            } catch (e) {} finally {
                if (buf) _7727dff8(buf);
                if (status) _7727dff8(status);
                if (ret) _7727dff8(ret)
            }
            return func
        }
    ...
    function preRun() {
        ...
        callRuntimeCallbacks(_48d84642)
    }

    function ensureInitRuntime() {
        if (runtimeInitialized) return;
        runtimeInitialized = true;
        callRuntimeCallbacks(_74386680)
    }

    function preMain() {
        callRuntimeCallbacks(_541a3222)
    }

    function exitRuntime() {
        callRuntimeCallbacks(_5f2569c4);
        runtimeExited = true
    }
    ...
    function postRun() {
        ...
        callRuntimeCallbacks(_17093dab)
    }

    function addOnPreRun(cb) {
        _48d84642.unshift(cb)
    }
    Module["addOnPreRun"] = addOnPreRun;

    function addOnInit(cb) {
        _74386680.unshift(cb)
    }
    Module["addOnInit"] = addOnInit;

    function addOnPreMain(cb) {
        _541a3222.unshift(cb)
    }
    Module["addOnPreMain"] = addOnPreMain;

    function addOnExit(cb) {
        _5f2569c4.unshift(cb)
    }
    Module["addOnExit"] = addOnExit;

    function addOnPostRun(cb) {
        _17093dab.unshift(cb)
    }
    ...
    function integrateWasmJS(Module) {
        ...
        var wasmTextFile = Module["wasmTextFile"] || "build_5d3c85aad8642f8b14ad7cfa43a007b4a9b15c8a.wasm.wast";
        var wasmBinaryFile = Module["wasmBinaryFile"] || "build_5d3c85aad8642f8b14ad7cfa43a007b4a9b15c8a.wasm.wasm";
        var asmjsCodeFile = Module["asmjsCodeFile"] || "build_5d3c85aad8642f8b14ad7cfa43a007b4a9b15c8a.wasm.temp.asm.js";
        ...
        function doWasmPolyfill(global, env, providedBuffer, method) {
            ...
            if (method == "interpret-asm2wasm") {
                temp = wasmJS["_1f495e7f"](code.length + 1);
                wasmJS["writeAsciiToMemory"](code, temp);
                wasmJS["_760b7f01"](temp)
            } else if (method === "interpret-s-expr") {
                temp = wasmJS["_1f495e7f"](code.length + 1);
                wasmJS["writeAsciiToMemory"](code, temp);
                wasmJS["_41104a32"](temp)
            } else if (method === "interpret-binary") {
                temp = wasmJS["_1f495e7f"](code.length);
                wasmJS["HEAPU8"].set(code, temp);
                wasmJS["_75599e5b"](temp, code.length)
            } else {
                throw "what? " + method
            }
            wasmJS["_7727dff8"](temp);
            wasmJS["_775b4d2e"](temp);
            if (Module["newBuffer"]) {
        ...
        Module["reallocBuffer"] = (function(size) {
            ...
            if (Module["usingWasm"]) {
                ...
                exports["_4b6298fd"]((size - oldSize) / wasmPageSize);
    ...
    var ASM_CONSTS = [(function() {
    ...
    }), (function($0) {
        {
            ...
            for (var i = 0; i < w.events.length; ++i) _7727dff8(w.events[i][1]);
            w.events = null;
            try {
                w.close()
            } catch (e) {}
    ...
    function _1cd9d271(code, a0, a1, a2, a3) {
        return ASM_CONSTS[code](a0, a1, a2, a3)
    }

    function _5ebfa370(code, a0, a1) {
        return ASM_CONSTS[code](a0, a1)
    }

    function _1b38b771(code, a0) {
        return ASM_CONSTS[code](a0)
    }

    function _3f58298b(code) {
        return ASM_CONSTS[code]()
    }

    function _4f4d5949(code, a0, a1, a2, a3) {
        return ASM_CONSTS[code](a0, a1, a2, a3)
    }

    function _32830e94(code, a0) {
        return ASM_CONSTS[code](a0)
    }

    function _1c1b3546(code, a0, a1) {
        return ASM_CONSTS[code](a0, a1)
    }

    function _37f8a24(code, a0, a1, a2) {
        return ASM_CONSTS[code](a0, a1, a2)
    }

    function _658486d1(code, a0, a1, a2, a3, a4) {
        return ASM_CONSTS[code](a0, a1, a2, a3, a4)
    }

    function _5ae529a6(code, a0, a1, a2) {
        return ASM_CONSTS[code](a0, a1, a2)
    }

    function _4853f8ee(code) {
        return ASM_CONSTS[code]()
    }

    function _1e2d950(code, a0, a1, a2, a3, a4, a5) {
        return ASM_CONSTS[code](a0, a1, a2, a3, a4, a5)
    }

    function _52392e3c(code, a0, a1, a2, a3, a4) {
        return ASM_CONSTS[code](a0, a1, a2, a3, a4)
    }

    function _6b02e8fe(code, a0, a1, a2, a3) {
        return ASM_CONSTS[code](a0, a1, a2, a3)
    }

    function _40b18a42(code, a0, a1) {
        return ASM_CONSTS[code](a0, a1)
    }

    function _72b5d880(code, a0, a1, a2, a3, a4, a5, a6) {
        return ASM_CONSTS[code](a0, a1, a2, a3, a4, a5, a6)
    }

    function _7cc91a7e(code, a0, a1) {
        return ASM_CONSTS[code](a0, a1)
    }
    STATIC_BASE = 1024;
    STATICTOP = STATIC_BASE + 183136;
    _74386680.push({
        func: (function() {
            _33ecef9a()
        })
    ...
    memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "build_5d3c85aad8642f8b14ad7cfa43a007b4a9b15c8a.wasm.js.mem" : null;
    var STATIC_BUMP = 183136;
    Module["STATIC_BASE"] = STATIC_BASE;
    Module["STATIC_BUMP"] = STATIC_BUMP;
    var tempDoublePtr = STATICTOP;
    STATICTOP += 16;
    Module["_13ea64c4"] = _13ea64c4;

    function _12837f2e(condition, filename, line, func) {
        ABORT = true;
        throw "Assertion failed: " + Pointer_stringify(condition) + ",  at: " + [filename ? Pointer_stringify(filename) : "unknown filename", line, func ? Pointer_stringify(func) : "unknown function"] + " at " + stackTrace()
    }
    Module["_4bc48aea"] = _4bc48aea;
    Module["_4e86e1b8"] = _4e86e1b8;
    Module["_19a362d4"] = _19a362d4;

    function _2ba4c848(year) {
        return year % 4 === 0 && (year % 100 !== 0 || year % 400 === 0)
    }

    function _42bcdd48(array, index) {
        var sum = 0;
        for (var i = 0; i <= index; sum += array[i++]);
        return sum
    }
    var _4400eb4e = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    var _6d93179c = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

    function _59df73b8(date, days) {
        var newDate = new Date(date.getTime());
        while (days > 0) {
            var leap = _2ba4c848(newDate.getFullYear());
            var currentMonth = newDate.getMonth();
            var daysInCurrentMonth = (leap ? _4400eb4e : _6d93179c)[currentMonth];
    ...
    function _35f74bfe(s, maxsize, format, tm) {
        ...
        function getWeekBasedYear(date) {
            var thisDate = _59df73b8(new Date(date.tm_year + 1900, 0, 1), date.tm_yday);
        ...
        var EXPANSION_RULES_2 = {
            ...
            "%j": (function(date) {
                return leadingNulls(date.tm_mday + _42bcdd48(_2ba4c848(date.tm_year + 1900) ? _4400eb4e : _6d93179c, date.tm_mon - 1), 3)
            }),
            "%m": (function(date) {
            ...
            "%U": (function(date) {
                ...
                var firstSunday = janFirst.getDay() === 0 ? janFirst : _59df73b8(janFirst, 7 - janFirst.getDay());
                var endDate = new Date(date.tm_year + 1900, date.tm_mon, date.tm_mday);
                if (compareByDay(firstSunday, endDate) < 0) {
                    var februaryFirstUntilEndMonth = _42bcdd48(_2ba4c848(endDate.getFullYear()) ? _4400eb4e : _6d93179c, endDate.getMonth() - 1) - 31;
            ...
            "%V": (function(date) {
                ...
                var firstWeekStartThisYear = getFirstWeekStartDate(janFourthThisYear);
                var firstWeekStartNextYear = getFirstWeekStartDate(janFourthNextYear);
                var endDate = _59df73b8(new Date(date.tm_year + 1900, 0, 1), date.tm_yday);
            ...
            "%W": (function(date) {
                ...
                var firstMonday = janFirst.getDay() === 1 ? janFirst : _59df73b8(janFirst, janFirst.getDay() === 0 ? 1 : 7 - janFirst.getDay() + 1);
                var endDate = new Date(date.tm_year + 1900, date.tm_mon, date.tm_mday);
    ...
    function _52dbcc75(s, maxsize, format, tm) {
        return _35f74bfe(s, maxsize, format, tm)
    }
    ...
    function _433abf2(mode, value) {
        ...
        if (mode == 0) {
            Browser.mainLoop.scheduler = function Browser_mainLoop_scheduler_setTimeout() {
                var timeUntilNextTick = Math.max(0, Browser.mainLoop.tickStartTime + value - _7c12dbe3()) | 0;
    ...
    function _601ac119(func, fps, simulateInfiniteLoop, arg, noSetTiming) {
        Module["noExitRuntime"] = true;
        ...
        Browser.mainLoop.runner = function Browser_mainLoop_runner() {
            ...
            if (Browser.mainLoop.timingMode == 1 && Browser.mainLoop.timingValue > 1 && Browser.mainLoop.currentFrameNumber % Browser.mainLoop.timingValue != 0) {
                ...
                Browser.mainLoop.tickStartTime = _7c12dbe3()
            }
        ...
        if (!noSetTiming) {
            if (fps && fps > 0) _433abf2(0, 1e3 / fps);
            else _433abf2(1, 1);
            Browser.mainLoop.scheduler()
        }
    ...
    var Browser = {
        mainLoop: {
            ...
            resume: (function() {
                ...
                _601ac119(func, 0, false, Browser.mainLoop.arg, true);
                _433abf2(timingMode, timingValue);
                Browser.mainLoop.scheduler()
            }),
    ...
    function _2c853f4b(status) {
        Module["noExitRuntime"] = false;
        Module["exit"](status)
    }
    var _1996ca7c = Math_pow;
    Module["_18cd5514"] = _18cd5514;
    ...
    function _464168df(which, varargs) {
    ...
    function _15cc8d14(which, varargs) {
        SYSCALLS.varargs = varargs;
        try {
            return 0
        } catch (e) {
    ...
    Module["_5c332091"] = _5c332091;

    function _15e972da() {
        ABORT = true;
        throw "Pure virtual function called!"
    }
    Module["_7e187006"] = _7e187006;
    var _4e207e56 = STATICTOP;
    STATICTOP += 16;

    function _60d57d9c(env) {
        var MAX_ENV_VALUES = 64;
        var TOTAL_ENV_SIZE = 1024;
        var poolPtr;
        var envPtr;
        if (!_60d57d9c.called) {
            _60d57d9c.called = true;
            ...
            HEAP32[_4e207e56 >> 2] = envPtr
        } else {
            envPtr = HEAP32[_4e207e56 >> 2];
    ...
    function _798ee4f3(name) {
        if (name === 0) return 0;
        name = Pointer_stringify(name);
        if (!ENV.hasOwnProperty(name)) return 0;
        if (_798ee4f3.ret) _7727dff8(_798ee4f3.ret);
        _798ee4f3.ret = allocate(intArrayFromString(ENV[name]), "i8", ALLOC_NORMAL);
        return _798ee4f3.ret
    }
    var ERRNO_CODES = {
        EPERM: 1,
        ENOENT: 2,
    ...
    function _4cdea6ba(value) {
        if (Module["_c0371"]) HEAP32[Module["_c0371"]() >> 2] = value;
        return value
    }

    function _624e0f32(pathname, size) {
        _4cdea6ba(ERRNO_CODES.EPERM);
        return -1
    }
    Module["_d0d8cbd"] = _d0d8cbd;
    var cttz_i8 = allocate([8, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 6, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 7, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 6, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0], "i8", ALLOC_STATIC);

    function _519fbe3c(x) {
        x = x | 0;
        var ret = 0;
    ...
    Module["_33204dcb"] = _33204dcb;
    Module["_4e348392"] = _4e348392;

    function _39f8af9(dest, src, num) {
        HEAPU8.set(HEAPU8.subarray(src, src + num), dest);
        return dest
    }
    Module["_410d1225"] = _410d1225;

    function _295475d(which, varargs) {
        SYSCALLS.varargs = varargs;
        try {
    ...
    function _6bebe795() {
        return !!_6bebe795.uncaught_exception
    }
    Module["_44e6bc93"] = _44e6bc93;
    Module["_3fbbc2b9"] = _3fbbc2b9;
    var _3a85d841 = Math_pow;
    Module["_37e5e84c"] = _37e5e84c;
    Module["_55b68129"] = _55b68129;
    Module["_4acbc4a7"] = _4acbc4a7;
    Module["_60059926"] = _60059926;

    function _57f09f84() {
        return 0
    }
    Module["_26c18388"] = _26c18388;

    function _2856ccc4(which, varargs) {
        SYSCALLS.varargs = varargs;
        try {
            var stream = SYSCALLS.getStreamFromFD(),
    ...
    function _1568617f(which, varargs) {
        SYSCALLS.varargs = varargs;
        try {
            ...
            var ret = 0;
            if (!_1568617f.buffer) {
                _1568617f.buffers = [null, [],
                    []
                ];
                _1568617f.printChar = (function(stream, curr) {
                    var buffer = _1568617f.buffers[stream];
                    assert(buffer);
                    if (curr === 0 || curr === 10) {
            ...
            for (var i = 0; i < iovcnt; i++) {
                ...
                for (var j = 0; j < len; j++) {
                    _1568617f.printChar(stream, HEAPU8[ptr + j])
                }
                ret += len
            }
            return ret
    ...
    _60d57d9c(ENV);
    _5f2569c4.push((function() {
        var fflush = Module["_6231c1db"];
        if (fflush) fflush(0);
        var printChar = _1568617f.printChar;
        if (!printChar) return;
        var buffers = _1568617f.buffers;
    ...
    Module["asm"] = asm;
    var _77a9e54a = Module["_77a9e54a"] = (function() {
        return Module["asm"]["_77a9e54a"].apply(null, arguments)
    });
    var _33ecef9a = Module["_33ecef9a"] = (function() {
        return Module["asm"]["_33ecef9a"].apply(null, arguments)
    });
    var _4bc48aea = Module["_4bc48aea"] = (function() {
        return Module["asm"]["_4bc48aea"].apply(null, arguments)
    });
    var _7cf8f909 = Module["_7cf8f909"] = (function() {
        return Module["asm"]["_7cf8f909"].apply(null, arguments)
    });
    var _7228d7fa = Module["_7228d7fa"] = (function() {
        return Module["asm"]["_7228d7fa"].apply(null, arguments)
    });
    ...
    var _41883ce = Module["_41883ce"] = (function() {
        return Module["asm"]["_41883ce"].apply(null, arguments)
    });
    var _4e348392 = Module["_4e348392"] = (function() {
        return Module["asm"]["_4e348392"].apply(null, arguments)
    });
    var _241c4e8d = Module["_241c4e8d"] = (function() {
        return Module["asm"]["_241c4e8d"].apply(null, arguments)
    });
    var setThrew = Module["setThrew"] = (function() {
        return Module["asm"]["setThrew"].apply(null, arguments)
    });
    var _72a4bb00 = Module["_72a4bb00"] = (function() {
        return Module["asm"]["_72a4bb00"].apply(null, arguments)
    });
    var _10f76ef = Module["_10f76ef"] = (function() {
        return Module["asm"]["_10f76ef"].apply(null, arguments)
    });
    var _5c332091 = Module["_5c332091"] = (function() {
        return Module["asm"]["_5c332091"].apply(null, arguments)
    });
    var _55b68129 = Module["_55b68129"] = (function() {
        return Module["asm"]["_55b68129"].apply(null, arguments)
    });
    var _2caae9bd = Module["_2caae9bd"] = (function() {
        return Module["asm"]["_2caae9bd"].apply(null, arguments)
    });
    var setTempRet0 = Module["setTempRet0"] = (function() {
        return Module["asm"]["setTempRet0"].apply(null, arguments)
    });
    var _791878ad = Module["_791878ad"] = (function() {
        return Module["asm"]["_791878ad"].apply(null, arguments)
    });
    var _1f370367 = Module["_1f370367"] = (function() {
        return Module["asm"]["_1f370367"].apply(null, arguments)
    });
    var _4e86e1b8 = Module["_4e86e1b8"] = (function() {
        return Module["asm"]["_4e86e1b8"].apply(null, arguments)
    });
    var _37e5e84c = Module["_37e5e84c"] = (function() {
        return Module["asm"]["_37e5e84c"].apply(null, arguments)
    });
    var _410d1225 = Module["_410d1225"] = (function() {
        return Module["asm"]["_410d1225"].apply(null, arguments)
    });
    var stackAlloc = Module["stackAlloc"] = (function() {
        return Module["asm"]["stackAlloc"].apply(null, arguments)
    });
    var _3fbbc2b9 = Module["_3fbbc2b9"] = (function() {
        return Module["asm"]["_3fbbc2b9"].apply(null, arguments)
    });
    var _1cf3bd50 = Module["_1cf3bd50"] = (function() {
        return Module["asm"]["_1cf3bd50"].apply(null, arguments)
    });
    var _60059926 = Module["_60059926"] = (function() {
        return Module["asm"]["_60059926"].apply(null, arguments)
    });
    var _3b3b5ac3 = Module["_3b3b5ac3"] = (function() {
        return Module["asm"]["_3b3b5ac3"].apply(null, arguments)
    });
    var _190bde0b = Module["_190bde0b"] = (function() {
        return Module["asm"]["_190bde0b"].apply(null, arguments)
    });
    var _13ea64c4 = Module["_13ea64c4"] = (function() {
        return Module["asm"]["_13ea64c4"].apply(null, arguments)
    });
    var _33204dcb = Module["_33204dcb"] = (function() {
        return Module["asm"]["_33204dcb"].apply(null, arguments)
    });
    var _74290383 = Module["_74290383"] = (function() {
        return Module["asm"]["_74290383"].apply(null, arguments)
    });
    var _18cd5514 = Module["_18cd5514"] = (function() {
        return Module["asm"]["_18cd5514"].apply(null, arguments)
    });
    var _57c9aa16 = Module["_57c9aa16"] = (function() {
        return Module["asm"]["_57c9aa16"].apply(null, arguments)
    });
    var _d0d8cbd = Module["_d0d8cbd"] = (function() {
        return Module["asm"]["_d0d8cbd"].apply(null, arguments)
    });
    var _726416a = Module["_726416a"] = (function() {
        return Module["asm"]["_726416a"].apply(null, arguments)
    });
    var _345b2ed4 = Module["_345b2ed4"] = (function() {
        return Module["asm"]["_345b2ed4"].apply(null, arguments)
    });
    var _7e187006 = Module["_7e187006"] = (function() {
        return Module["asm"]["_7e187006"].apply(null, arguments)
    });
    var _26c18388 = Module["_26c18388"] = (function() {
        return Module["asm"]["_26c18388"].apply(null, arguments)
    });
    var _44e6bc93 = Module["_44e6bc93"] = (function() {
        return Module["asm"]["_44e6bc93"].apply(null, arguments)
    });
    var _49f8eea6 = Module["_49f8eea6"] = (function() {
        return Module["asm"]["_49f8eea6"].apply(null, arguments)
    });
    var _7727dff8 = Module["_7727dff8"] = (function() {
        return Module["asm"]["_7727dff8"].apply(null, arguments)
    });
    var runPostSets = Module["runPostSets"] = (function() {
        return Module["asm"]["runPostSets"].apply(null, arguments)
    });
    var _5b51635e = Module["_5b51635e"] = (function() {
        return Module["asm"]["_5b51635e"].apply(null, arguments)
    });
    var _4acbc4a7 = Module["_4acbc4a7"] = (function() {
        return Module["asm"]["_4acbc4a7"].apply(null, arguments)
    });
    var _19185cfa = Module["_19185cfa"] = (function() {
        return Module["asm"]["_19185cfa"].apply(null, arguments)
    });
    var stackRestore = Module["stackRestore"] = (function() {
        return Module["asm"]["stackRestore"].apply(null, arguments)
    });
    var _1f495e7f = Module["_1f495e7f"] = (function() {
        return Module["asm"]["_1f495e7f"].apply(null, arguments)
    });
    var establishStackSpace = Module["establishStackSpace"] = (function() {
        return Module["asm"]["establishStackSpace"].apply(null, arguments)
    });
    var _19a362d4 = Module["_19a362d4"] = (function() {
        return Module["asm"]["_19a362d4"].apply(null, arguments)
    });
    var _4c7060a8 = Module["_4c7060a8"] = (function() {
        return Module["asm"]["_4c7060a8"].apply(null, arguments)
    });
    var _14f2e186 = Module["_14f2e186"] = (function() {
        return Module["asm"]["_14f2e186"].apply(null, arguments)
    });
    ...
    Module["callMain"] = Module.callMain = function callMain(args) {
        ...
        try {
            var ret = Module["_7228d7fa"](argc, argv, 0);
            exit(ret, true)
        } catch (e) {
            if (e instanceof ExitStatus) {
                return
    ...
    function run(args) {
        ...
        function doRun() {
            ...
            if (Module["_7228d7fa"] && shouldRunNow) Module["callMain"](args);
            postRun()
        }
        if (Module["setStatus"]) {
